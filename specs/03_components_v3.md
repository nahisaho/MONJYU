...
**準拠アーキテクチャ**: [02_architecture_v3.md](02_architecture_v3.md) v3.1.0 (Approved)
...
| 3.0.0 | 2025-12-24 | v3.0 要件対応、学術論文特化 |
| 3.1.0 | 2025-12-27 | 実装ステータス追加 (28/32 = 87.5%)、アーキテクチャv3.1準拠 |
| 3.0.0 | 2025-12-24 | v3.0要件対応、学術論文特化、MCP Server追加 |
