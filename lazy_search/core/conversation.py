...
"""
Conversation history management for LazyGraphRAG.

This module contains classes for storing and managing conversation history,
...
class QATurn:
    ...
    A QA turn contains a user question and one or more assistant answers.
    """
...
class ConversationHistory:
    ...
    def from_list(
        ...
        Each turn is a dictionary in the form of:
        {"role": "<conversation_role>", "content": "<turn content>"}
        """
        history = cls()
    ...
    def build_context(
        ...
        ----------
            ...
            include_user_turns_only: If True, only user queries will be included.
            max_qa_turns: Maximum number of QA turns to include.
            max_context_tokens: Maximum tokens for the context.
            recency_bias: If True, prioritize recent conversations.
            column_delimiter: Delimiter for CSV output.
            context_name: Name of the context section.

        Returns
        -------
            Tuple of (context_text, context_dataframes)
        """
